...
insert  into `tb_users`(`idUser`,`username`,`cpf`,`usertype`,`email`,`passwd`) values (1,'Pedro Lucas Bezerra','49368111812','A','pedro@gmail.com','$2y$12$sU4UaulY1ufHVDGECq.f5OteQQxHTa8OqWY0cvmV3q8VecFSmrRWS');
