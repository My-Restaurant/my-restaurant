...
/* Procedure structure for procedure `sp_orderItems_delete` */

/*!50003 DROP PROCEDURE IF EXISTS  `sp_orderItems_delete` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_orderItems_delete`(
	IN pId INT,
    IN pQtd INT,
    IN pOrder INT
)
